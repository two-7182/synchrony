...
class Connectivity:
    ...
    def spatial_connect(self):
        ...
        '''
        neurons_coord = np.array(list(itertools.product(range(self.height), range(self.width))))
    ...
    def build(self, angle_connect_strength=0.5, spatial_connect_strength=0.5, total_connect_strength=1):
        '''
        ...
        '''
        return (self.angle_connect() * angle_connect_strength + self.spatial_connect() * spatial_connect_strength) * total_connect_strength
    
    def detect_angles(self, img):
        '''
